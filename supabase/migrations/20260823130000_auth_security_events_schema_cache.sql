-- Idempotent repair for authentication security event storage and PostgREST schema cache.
...
grant insert, select on public.auth_security_events to service_role;
