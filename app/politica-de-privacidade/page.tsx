...
export const metadata: Metadata = {
  ...
  description: "Política de privacidade do VetorCAD Converter, incluindo dados de conta, projetos, pagamentos e publicidade.",
...
const sections = [
  ...
  ["Pagamentos", "Pagamentos podem ser processados por parceiros como o Mercado Pago. Dados sensíveis de cartão não são armazenados diretamente pelo VetorCAD."],
  ...
  return (
    <PublicSiteShell>
      <section className="mx-auto max-w-4xl px-4 py-16 lg:px-8">
        ...
        <p className="mt-5 leading-7 text-[#aebeb6]">Esta política explica como o VetorCAD Converter trata dados para operar o SaaS, salvar projetos e oferecer recursos de conversão CAD.</p>
