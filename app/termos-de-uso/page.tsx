...
export const metadata: Metadata = {
  ...
  description: "Termos de uso do VetorCAD Converter para conversão de imagens em SVG, DXF e modelos 3D.",
  alternates: { canonical: "https://vetorcad.com.br/termos-de-uso" },
};

const terms = [
  ["Uso permitido", "O usuário pode usar o VetorCAD para converter imagens próprias ou imagens que tenha autorização para processar."],
  ...
  return (
    <PublicSiteShell>
      <section className="mx-auto max-w-4xl px-4 py-16 lg:px-8">
        ...
        <p className="mt-5 leading-7 text-[#aebeb6]">Ao usar o VetorCAD Converter, você concorda com estes termos e entende que resultados técnicos devem ser revisados antes de produção.</p>
