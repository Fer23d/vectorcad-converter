...
export const metadata: Metadata = {
  title: "VectorCAD Converter | PNG e JPG para SVG e DXF editavel",
  description: "Converta imagens em vetores para CAD, corte laser, CNC, AutoCAD, CorelDRAW e Illustrator com exportacao SVG, DXF e preview 3D.",
  alternates: { canonical: "https://vetorcad.com.br/" },
};

const benefits = [
  "DXF com linhas e contornos editaveis para CAD/CAM",
  "SVG limpo para CorelDRAW, Illustrator e fluxos web",
  "Ajustes de threshold, contraste, ruido e escala real em mm",
  "Base para extrusao 3D e exportacao STL/GLB",
];

const steps = [
  { title: "1. Envie a imagem", text: "Use PNG, JPG, JPEG ou WEBP com boa resolucao e contraste." },
  { title: "2. Limpe o desenho", text: "Ajuste brilho, contraste, limiar, ruido e bordas antes da vetorizacao." },
  { title: "3. Gere o vetor", text: "Transforme areas da imagem em paths, contornos e polilinhas editaveis." },
  { title: "4. Exporte para CAD", text: "Baixe SVG ou DXF com escala correta para abrir em softwares tecnicos." },
];

const faqs = [
  { q: "O VectorCAD substitui um desenhista CAD?", a: "Ele reduz o redesenho manual em imagens simples, logos e contornos. Em desenhos complexos, ainda pode ser necessario revisar e ajustar o arquivo final." },
  { q: "O DXF abre no AutoCAD?", a: "Sim. A exportacao e feita com entidades editaveis como polilinhas e layers, pensadas para importacao em AutoCAD e fluxos CAD/CAM." },
  ...
  return (
    <PublicSiteShell>
      <section className="relative overflow-hidden border-b border-[#1c2822]">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-20 lg:grid-cols-[1.1fr_.9fr] lg:px-8 lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[#b8c8c0]">O VectorCAD Converter converte PNG, JPG e WEBP em SVG e DXF editaveis, com pre-processamento de imagem, vetorizacao por contorno, escala em milimetros e exportacao pronta para softwares como AutoCAD, Fusion 360, CorelDRAW e Illustrator.</p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/signup" className="rounded-2xl bg-[#b7f34a] px-6 py-4 text-sm font-black text-[#07100a] transition hover:brightness-105">Comecar agora</Link>
      ...
      <section className="border-y border-[#1c2822] bg-[#0a0f0d]">
        <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-black tracking-[-.03em] md:text-4xl">Como funciona a conversao CAD</h2>
            <p className="mt-4 leading-7 text-[#aebeb6]">A ferramenta analisa a imagem, separa areas claras e escuras, remove pequenos ruidos e transforma bordas em caminhos vetoriais. O resultado pode ser exportado em SVG para design ou DXF para CAD/CAM.</p>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-16 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
        <div>
          <h2 className="text-3xl font-black tracking-[-.03em] md:text-4xl">Por que vetor CAD nao e apenas um SVG bonito?</h2>
          <p className="mt-4 leading-7 text-[#aebeb6]">Para ser util em CAD, o arquivo precisa ter geometrias editaveis, escala coerente, contornos fechados quando possivel e poucos pontos desnecessarios. O VectorCAD prioriza esse fluxo tecnico para reduzir ajustes depois da importacao.</p>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-3 text-[#aebeb6]">Conteudo editorial para preparar imagens, vetores e arquivos CAD com menos retrabalho.</p>
            </div>
