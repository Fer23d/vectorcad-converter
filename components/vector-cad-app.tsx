  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_50%_-20%,#1d3428_0,#080c0b_42%)]">
    ...
    {source && <section className="grid min-h-[calc(100vh-64px)] grid-cols-1 lg:grid-cols-[250px_1fr_270px]">
      ...
      <aside className="border-l border-[#26312c] bg-[#0d1210] p-4">
        ...
        <div className="mt-5 rounded-xl border border-[#38483f] bg-[#151e19] p-3 text-[10px] leading-5 text-[#aab7b0]"><b className="text-[#b7f34a]">Pronto para CAD</b><br />O DXF usa entidades LWPOLYLINE editáveis e layers separados.</div>
