...
import { BarChart3, FolderOpen, ShieldAlert, ShieldCheck, UsersRound } from "lucide-react";
  ...
  return <main className="min-h-screen bg-[#080c0b] text-[#e8efeb]">
    ...
    <section className="mx-auto max-w-7xl px-5 py-6">
      <div className="grid gap-4 md:grid-cols-3">
        <StatCard icon={<UsersRound size={20} />} label="Usuarios" value={overview.stats.totalUsers} />
        <StatCard icon={<FolderOpen size={20} />} label="Projetos" value={overview.stats.totalProjects} />
        <StatCard icon={<BarChart3 size={20} />} label="Status" value="Online" />
      </div>
        ...
        <section className="rounded-3xl border border-[#26312c] bg-[#101613] p-5">
          ...
          <div className="mt-4 overflow-x-auto">
            <table className="w-full min-w-[560px] text-left text-xs">
              <thead className="text-[#7c8b83]"><tr><th className="py-2">Email</th><th>ID</th><th>Criado em</th></tr></thead>
              <tbody>
