      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 py-20 lg:grid-cols-[.9fr_1.1fr] lg:px-8 lg:py-28">
        ...
        <div className={`${styles.mockup} relative mx-auto w-full max-w-2xl`}>
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-[#304238] bg-[#0b120e] shadow-2xl shadow-black/45">
            <div className="flex items-center justify-between border-b border-[#223028] px-5 py-4"><div className="flex items-center gap-3"><span className="h-2 w-2 rounded-full bg-[#b7f34a] shadow-[0_0_12px_#b7f34a]" /><span className="text-xs font-black text-[#edf5f0]">VetorCAD Converter</span></div><span className="rounded-full border border-[#b7f34a]/30 bg-[#b7f34a]/10 px-3 py-1 text-[10px] font-black text-[#b7f34a]">Workspace</span></div>
            <div className="grid gap-0 md:grid-cols-[.35fr_1fr]">
              <div className="hidden border-r border-[#223028] bg-[#09100c] p-4 md:block"><div className="mb-5 h-2 w-16 rounded-full bg-[#b7f34a]/70" /><div className="space-y-2 text-[10px] font-bold text-[#7f9188]"><div className="rounded-lg bg-[#b7f34a]/10 px-3 py-2 text-[#b7f34a]">Projeto atual</div><div className="px-3 py-2">Camadas</div><div className="px-3 py-2">Analise do projeto</div><div className="px-3 py-2">Exportacoes</div></div><div className="mt-16 rounded-xl border border-[#223028] p-3"><div className="text-[9px] uppercase tracking-[.16em] text-[#718279]">Status</div><div className="mt-2 text-xs font-black text-[#b7f34a]">Pronto para revisar</div></div></div>
